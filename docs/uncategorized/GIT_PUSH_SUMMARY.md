...
- `../quick-references/TESTING_QUICK_REFERENCE.md` - Quick reference for all test scripts
- `../implementation-summaries/dashboard/DASHBOARD_ENHANCEMENT_SUMMARY.md` - Dashboard enhancement summary
- `../implementation-summaries/wizard/WIZARD_BACKEND_IMPLEMENTATION.md` - Wizard backend implementation details
- `../implementation-summaries/wizard/WIZARD_FRONTEND_BACKEND_INTEGRATION.md` - Frontend/backend integration
- `../implementation-summaries/wizard/WIZARD_FRONTEND_VERIFICATION.md` - Frontend verification results
- `../implementation-summaries/testing/INFRASTRUCTURE_TESTING_IMPLEMENTATION.md` - Infrastructure testing details
- `../implementation-summaries/testing/INSTALLATION_TESTING_IMPLEMENTATION.md` - Installation testing details
- `../implementation-summaries/tasks/TASK_3.8_COMPLETION_SUMMARY.md` - Task 3.8 completion summary
- `../implementation-summaries/integrations/KASIA_INDEXER_VALIDATION_SUMMARY.md` - Kasia indexer validation
