...
- [ ] Test Scenario 1: Core Profile (follow TESTING.md)
- [ ] Test Scenario 2: Kaspa User Applications (follow TESTING.md)
...
- [ ] Document time taken for each scenario
- [ ] Document any issues or confusion
- [ ] Update TESTING.md based on findings
