...
2. **Follow the comprehensive checklist**:
   - See `../testing/ROLLBACK_TESTING_CHECKLIST.md`
...
- `../testing/ROLLBACK_TESTING_CHECKLIST.md` - Comprehensive manual testing guide
...
**Manual Checklist**: `../testing/ROLLBACK_TESTING_CHECKLIST.md`  
